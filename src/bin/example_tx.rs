...
use goose_packet::pdu::{encodeGoosePacket,getTimeMs,display_buffer};
...
fn main(){
    ...
    let goose_packet = IECGoosePacket{ eth_hdr: ether_header, goose_hdr: goose_header, pdu: goose_pdu, prp: None};
